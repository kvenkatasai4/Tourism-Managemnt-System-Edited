...
public class ModifyFood1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int total=(int) session.getAttribute("totalCost");
		...
		try{
			...
			ps.executeUpdate();
			if(total > totalCost) {
				out.println("Food "+foodName+" modified Successfully. Your money will be refunded");
			}else{
				out.println("Food modified Successfully. please pay remaining amount");
			}
