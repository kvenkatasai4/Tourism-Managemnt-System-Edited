...
$(document).ready(function(){
	...
	$('#form').submit(function(){
		...
		$.ajax({
			type:'POST',
			data:{ hotelName:hotelName,roomType:roomType,roomSize:roomSize,roomCost:roomCost,roomDate:roomDate, packagename:packagename, place:place, noOfRooms:noOfRooms,totalCost:totalCost},
			url:'../BookRoom',
			success: function(result){
				alert(result);
				if(result.trim()=="Please enter correct details"){
					window.location.href ="Room.jsp";
				}else{
					window.location.href ="AfterPackage.jsp";
				}
			}
		});	
	});
					...
					<div class="panel-body">
						<div class="row">
			    			...
			    			<div class="col-sm-4">
			    				...
			    				<div class="col-sm-4">
			    				<div class="form-group">
			    					<input class="form-control" type="text" value="1" id="noOfRooms" pattern="[0-9]" min="1" max="10" title="Please enter between 1 to 10 only" name="noOfRooms" required>
			    				</div>
			    				</div>
			    				</div>
			    			<div class="col-sm-12">
			    			<div class="col-sm-4">
			    				...
			    				<div class="col-sm-4">
			    				<div class="form-group">
			    					<input class="form-control" type="text" title="Cost for all the rooms" id="totalCost" name="totalCost" readonly>
			    				</div>
			    				</div>
			    				</div>
			    			<div class="col-sm-12">
			    			<div class="col-sm-4">
			    				...
			    				<div class="col-sm-4">
			    				<div class="form-group">
			    					<input class="form-control" type="Date" id="roomDate" name="roomDate" required>
			    				</div>
			    				</div>
			    				</div>
			    			<div class="col-sm-8">
			    			<div class="col-sm-4">
			    				<div class="form-group">
			    					<div class="text-right"> 
			    						<input type="submit" id="button" value="Book Room" class="btn btn-primary">
			    					</div>
			    				</div>
			    				</div>
			    				</div>
