			    	...
			    	<div class="row">
			    		<div class="col-sm-12">
			    			...
			    			<div class="col-sm-12">
			    				...
			    				<div class="col-sm-4">
			    				<div class="form-group">
			    					<input class="form-control" type="text" value="1"  id="quantity" name="quantity" pattern="[0-9]" min="1" max="10" title="Please enter between 1 to 10 only" name="noOfRooms" required>
			    				</div>
			    				</div>
				    			</div>
				    			<div class="col-sm-12">
			    				...
			    				<div class="col-sm-4">
			    				<div class="form-group">
			    					<input class="form-control" type="text" id="totalCost" name="totalCost" title="Cost for all the items" required readonly>
			    				</div>
			    				</div>
				    			</div>
				    			<div class="col-sm-12">
			    				...
			    				<div class="form-group">
			    					<div class="text-right"> 
			    						<input type="submit" id="button" value="Book Food" class="btn btn-primary">
			    					</div>
			    				</div>
			    				</div>
			    				</div>
