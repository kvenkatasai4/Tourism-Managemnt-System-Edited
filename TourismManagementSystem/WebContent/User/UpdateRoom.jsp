					...
					<div class="panel-body">
						<div class="row">
							<div class="col-sm-12">
			    				...
			    				<div class="col-sm-4">
			    				<div class="form-group">
			    					<input class="form-control" type="text" value="<%=session.getAttribute("noOfRooms1") %>" id="noOfRooms" name="noOfRooms" pattern="[0-9]" min="1" max="10" title="Please enter between 1 to 10 only" required>
			    				</div>
			    				</div>
			    				</div>
			    				<div class="col-sm-12">
			    				...
			    				<div class="col-sm-4">
			    				<div class="form-group">
			    					<input class="form-control" type="text" value="<%=session.getAttribute("totalCost1") %>" id="totalCost" name="totalCost" readonly>
			    				</div>
			    				</div>
			    				</div>
			    				<div class="col-sm-12">
			    				...
			    				<div class="col-sm-4">
			    				<div class="form-group">
			    					<input class="form-control" type="date" value="<%=session.getAttribute("roomDate1") %>" id="roomDate" name="roomDate" required>
			    				</div>
			    				</div>
			    				</div>
			    				<div class="col-sm-12">
			    				...
			    				<div class="form-group">
			    					<div class="text-right"> 
			    						<input type="submit" id="button" value="Modify Room" class="btn btn-primary">
			    					</div>
			    				</div>
			    				</div>
			    				</div>
