			    		...
			    		<div class="col-sm-12">
			    			...
			    			<div class="col-sm-12">
								...
								if(id.equals("1")){
									...
									a=tamount*10/100;
									due=tamount;
									messageReport ="you will get a coupon through email of ";
			    				...
			    				<div class="col-sm-4">
			    				<div class="form-group">
			    					<label><%=discount%>%</label><label id="report" hidden><%=messageReport%><%=a%>$</label>
			    				</div>
			    				</div>
			    				</div>
			    				<div class="col-sm-12">
			    				...
			    				<div class="col-sm-4">
			    				<div class="form-group">
			    					<input class="form-control" type="text" id="cardname" name="cardname" pattern="[A-Za-z\s]+" title="please enter only alphabets" required>
			    				</div>
			    				</div>
			    				</div>
			    				<div class="col-sm-12">
			    				...
			    				<div class="col-sm-4">
			    				<div class="form-group">
			    					<input class="form-control" type="text" value="" id="cardnumber" name="cardnumber" required pattern="[0-9]{16}" title="please enter 16 digit number">
			    				</div>
			    				</div>
			    				</div>
			    				<div class="col-sm-12">
			    				...
			    				<div class="col-sm-4">
			    				<div class="form-group">
			    					<input class="form-control" type="text" id="cvv" value="" name="cvv" required pattern="[0-9]{3}" title="please enter 3 digit number">
			    				</div>
			    				</div>
			    				</div>
			    				<div class="col-sm-12">
			    				...
			    				<div class="text-center">
			    				<div class="form-group"> 
			    					<input type="submit" id="button" value="Pay" class="btn btn-primary">
			    				</div>
			    				</div>
			    				</div>
			    				</div>
