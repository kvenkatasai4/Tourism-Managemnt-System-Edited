	...
	$('#form').submit(function(){
		...
		$.ajax({
			...
			success: function(result){
				alert(result);
				if(result.trim()=="Package already booked"){
			    	...
			    	<div class="row">
			    		<div class="col-sm-8">
			    			...
			    			<div class="col-sm-4">
			    				...
			    				<div class="col-sm-4">
			    				<div class="form-group">
			    					<input class="form-control" value="1" type="text" id="noofPersons" name="noofPersons" pattern="[0-9]" min="1" max="10" title="Please enter between 1 to 10 only" required>
			    				</div>
			    				</div>
			    			</div>
			    			<div class="col-sm-8">
			    			<div class="col-sm-4">
			    				...
			    				<div class="col-sm-4">
			    				<div class="form-group">
			    					<input class="form-control" type="text" id="totalcost" name="totalcost" title="Cost for all the persons" readonly>
			    				</div>
			    				</div>
			    			</div>
			    			<div class="col-sm-8">
			    			<div class="col-sm-4">
			    				<div class="form-group">
			    					<div class="text-right"> 
			    						<input type="submit" id="button" value="Book Package" class="btn btn-primary">
			    					</div>
			    				</div>
			    			</div>
			    			</div>
